...
mainbeam=20;     % width of the main lobe
mainbeam1=14;     % width of the main lobe
thetaM=40;      % location of the main lobe
thetaM1=110;
...
%% uniform spacing
d=[0,0.5*ones(1,elementNumber-1)];
...
A_M1=zeros(1,elementNumber);
for nn=1:length(d)
    A_M1(:,nn)=exp(1i*k*d(nn)*cosd(thetaM1));
end

%% Side lobe
theta_SL=[0:angleStep:thetaM-mainbeam/2,thetaM+mainbeam/2:angleStep:thetaM1-mainbeam1/2,thetaM1+mainbeam1/2:angleStep:180];
